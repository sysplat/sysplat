...
// .wrangler/tmp/bundle-LaO0aG/checked-fetch.js
...
// .wrangler/tmp/bundle-LaO0aG/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-X7JUQp/bundledWorker-0.2590941635749757.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, s, n) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let a of ae(t))
      !ie.call(e, a) && a !== s && q(e, a, { get: () => t[a], enumerable: !(n = re(t, a)) || n.enumerable });
  return e;
}, "ce");
var U = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? se(oe(e)) : {}, ce(t || !e || !e.__esModule ? q(s, "default", { value: e, enumerable: true }) : s, e)), "U");
var h;
var _ = C(() => {
  h = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let o = K(e, he), r = await n.get(a, { softTags: o });
      ...
      case "POST": {
        let o = globalThis[ge], r = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
          i.data.tags === void 0 && (i.tags ??= K(e, ue) ?? []), await n.set(a, i);
        }, "r");
...
// .wrangler/tmp/pages-X7JUQp/wexn5k1b4n9.js
...
// .wrangler/tmp/bundle-LaO0aG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LaO0aG/middleware-loader.entry.ts
